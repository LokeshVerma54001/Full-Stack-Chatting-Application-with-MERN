        ...
        bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    ...
                    w-full input input-bordered h-10" onChange={(e)=>
                ...
                <div>
                    ...
                    className="w-full input input-bordered h-10" onChange={(e)=>
                ...
                <div>
                    ...
                    border-slate-700 mt-2" disabled={loading}
